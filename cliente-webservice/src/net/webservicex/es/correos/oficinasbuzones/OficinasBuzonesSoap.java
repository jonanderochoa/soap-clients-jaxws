...
public interface OficinasBuzonesSoap {
    ...
    @RequestWrapper(localName = "ConsultaProvincias", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.ConsultaProvincias")
    @ResponseWrapper(localName = "ConsultaProvinciasResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.ConsultaProvinciasResponse")
    ...
    @RequestWrapper(localName = "TieneCallejero", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.TieneCallejero")
    @ResponseWrapper(localName = "TieneCallejeroResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.TieneCallejeroResponse")
    ...
    @RequestWrapper(localName = "ConsultaServiciosDisponiblesVisibles", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.ConsultaServiciosDisponiblesVisibles")
    @ResponseWrapper(localName = "ConsultaServiciosDisponiblesVisiblesResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.ConsultaServiciosDisponiblesVisiblesResponse")
    ...
    @RequestWrapper(localName = "InformacionInicial", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.InformacionInicial")
    @ResponseWrapper(localName = "InformacionInicialResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.InformacionInicialResponse")
    ...
    @RequestWrapper(localName = "ParesConCallejero", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.ParesConCallejero")
    @ResponseWrapper(localName = "ParesConCallejeroResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.ParesConCallejeroResponse")
    ...
    @RequestWrapper(localName = "DelimitaLocalidades", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DelimitaLocalidades")
    @ResponseWrapper(localName = "DelimitaLocalidadesResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DelimitaLocalidadesResponse")
    ...
    @RequestWrapper(localName = "BusquedaPorCodigoPostal", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoPostal")
    @ResponseWrapper(localName = "BusquedaPorCodigoPostalResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoPostalResponse")
    ...
    @RequestWrapper(localName = "BusquedaPorCodigoPostalSinFiltro", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoPostalSinFiltro")
    @ResponseWrapper(localName = "BusquedaPorCodigoPostalSinFiltroResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoPostalSinFiltroResponse")
    ...
    @RequestWrapper(localName = "BusquedaPorCodigoMunicipio", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoMunicipio")
    @ResponseWrapper(localName = "BusquedaPorCodigoMunicipioResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoMunicipioResponse")
    ...
    @RequestWrapper(localName = "BusquedaPorCodigoMunicipioExtendido", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoMunicipioExtendido")
    @ResponseWrapper(localName = "BusquedaPorCodigoMunicipioExtendidoResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoMunicipioExtendidoResponse")
    ...
    @RequestWrapper(localName = "DetalleOficina", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DetalleOficina")
    @ResponseWrapper(localName = "DetalleOficinaResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DetalleOficinaResponse")
    ...
    @RequestWrapper(localName = "DetalleBuzon", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DetalleBuzon")
    @ResponseWrapper(localName = "DetalleBuzonResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DetalleBuzonResponse")
    ...
    @RequestWrapper(localName = "BuscarLasMasCercanas", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BuscarLasMasCercanas")
    @ResponseWrapper(localName = "BuscarLasMasCercanasResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BuscarLasMasCercanasResponse")
    ...
    @RequestWrapper(localName = "DelimitaLocalidadesOficinasEntrega", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DelimitaLocalidadesOficinasEntrega")
    @ResponseWrapper(localName = "DelimitaLocalidadesOficinasEntregaResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.DelimitaLocalidadesOficinasEntregaResponse")
    ...
    @RequestWrapper(localName = "BusquedaPorCodigoPostalSinFiltroOficinasEntrega", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoPostalSinFiltroOficinasEntrega")
    @ResponseWrapper(localName = "BusquedaPorCodigoPostalSinFiltroOficinasEntregaResponse", targetNamespace = "OficinasBuzones", className = "net.webservicex.es.correos.oficinasbuzones.BusquedaPorCodigoPostalSinFiltroOficinasEntregaResponse")
