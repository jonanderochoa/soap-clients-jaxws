...
public interface BibleWebserviceSoap {
    ...
    @RequestWrapper(localName = "GetBibleWordsByChapterAndVerse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBibleWordsByChapterAndVerse")
    @ResponseWrapper(localName = "GetBibleWordsByChapterAndVerseResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBibleWordsByChapterAndVerseResponse")
    ...
    @RequestWrapper(localName = "GetBibleWordsbyKeyWord", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBibleWordsbyKeyWord")
    @ResponseWrapper(localName = "GetBibleWordsbyKeyWordResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBibleWordsbyKeyWordResponse")
    ...
    @RequestWrapper(localName = "GetBookTitles", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBookTitles")
    @ResponseWrapper(localName = "GetBookTitlesResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBookTitlesResponse")
    ...
    @RequestWrapper(localName = "GetBibleWordsByBookTitleAndChapter", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBibleWordsByBookTitleAndChapter")
    @ResponseWrapper(localName = "GetBibleWordsByBookTitleAndChapterResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.biblia.GetBibleWordsByBookTitleAndChapterResponse")
